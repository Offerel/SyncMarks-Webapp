...
RUN mkdir -p /run/nginx /var/log/nginx /var/log/syncmarks /var/lib/syncmarks /var/www/html /var/www/html/backups
RUN chown nobody:nobody /var/log/syncmarks /var/www/html /var/lib/syncmarks /var/www/html/backups
